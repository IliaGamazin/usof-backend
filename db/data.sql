...
-- Insert Root Comments (parent_id = NULL, 1-3 comments per post from different users)
INSERT INTO comments (author_id, post_id, parent_id, content) VALUES
-- Comments on Post 1
(2, 1, NULL, 'Great initiative! Looking forward to engaging discussions here.'),
(3, 1, NULL, 'Thanks for creating this platform. The interface looks clean and user-friendly.'),
(4, 1, NULL, 'Excited to be part of this community!'),

-- Comments on Post 2
(2, 2, NULL, 'These guidelines are very reasonable and clear.'),
(5, 2, NULL, 'Good to have clear expectations set from the beginning.'),

-- Comments on Post 3
(1, 3, NULL, 'Fascinating topic! AI will definitely reshape many industries.'),
(4, 3, NULL, 'I think we need to be cautious about AI ethics while embracing innovation.'),
(5, 3, NULL, 'The potential is huge, but we need proper regulations in place.'),

-- Comments on Post 4
(1, 4, NULL, 'Python and JavaScript remain strong choices for versatility.'),
(3, 4, NULL, 'Don''t forget about Rust! It''s gaining momentum for system programming.'),

-- Comments on Post 5
(2, 5, NULL, 'Solar and wind technology improvements are particularly promising.'),
(4, 5, NULL, 'We also need better battery storage solutions for renewable energy.'),

-- Comments on Post 6
(2, 6, NULL, 'Thanks for sharing! I''ve been looking for ways to improve my daily routine.'),
(4, 6, NULL, 'Exercise and good sleep are game-changers for sure.'),
(5, 6, NULL, 'Meal prep has been a huge help for me in maintaining healthy eating.'),

-- Comments on Post 7
(1, 7, NULL, 'Always looking for new series to binge-watch. Thanks for the recommendations!'),
(4, 7, NULL, 'Just started the first one you mentioned - loving it so far!'),

-- Comments on Post 8
(2, 8, NULL, 'The Mars missions have been incredible to follow.'),
(3, 8, NULL, 'Private space companies are really accelerating progress.'),
(5, 8, NULL, 'Can''t wait to see what the next decade brings for space exploration!'),

-- Comments on Post 9
(1, 9, NULL, 'Consistency is key! Great job documenting your journey.'),
(3, 9, NULL, 'Your progress is inspiring. I need to get back into a routine myself.'),

-- Comments on Post 10
(2, 10, NULL, 'VR gaming is getting so much better. The immersion is incredible now.'),
(5, 10, NULL, 'Mobile gaming revenue is actually surprising many people in the industry.'),

-- Comments on Post 11
(2, 11, NULL, 'Small changes really do add up over time. Great practical advice!'),
(4, 11, NULL, 'I''ve started composting at home - it''s easier than I thought.'),

-- Comments on Post 12
(3, 12, NULL, 'Adding these to my reading list! Always looking for good tech books.'),
(4, 12, NULL, 'Have you read "Clean Code"? It''s a classic that should be on every developer''s shelf.');
